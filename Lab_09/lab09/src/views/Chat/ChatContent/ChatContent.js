...
import {reciveMessage, emmitMessage} from '../../../utils/socket';
                ...
                <div className="card-header msg_head">
                    <div className="d-flex bd-highlight">
                        <div className="img_cont">
                            <img
                                src={getAvatar('yurand.coloma@tecsup.edu.pe')}
                                alt="user"
                        ...
                        <div className="user_info">
                            <span>Chat con Yurand Coloma</span>
                            <p>177 Mensajes</p>
                        </div>
                    </div>
                </div>
